...
public class IbDataInteractor extends BaseInteractor implements DataFetchInteractor, DataBroker.Callback {
    ...
    public IbDataInteractor(Executor executor, MainThread mainThread, Callback callback, String symbol, TimeInterval timeInterval, int length, DataBroker dataBroker) {
