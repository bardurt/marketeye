...
public class YahooDataInteractor extends BaseInteractor implements DataFetchInteractor, DataBroker.Callback {
    ...
    public YahooDataInteractor(Executor executor, MainThread mainThread, Callback callback, String symbol, TimeInterval timeInterval, DataSize length, DataBroker dataBroker) {
