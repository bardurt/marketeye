...
import com.zygne.stockanalyzer.presentation.presenter.implementation.delegates.alphavantage.flow.PivotFlow;
import com.zygne.stockanalyzer.presentation.presenter.implementation.delegates.alphavantage.flow.ResistanceFlow;
import com.zygne.stockanalyzer.presentation.presenter.implementation.delegates.alphavantage.flow.SupportFlow;
...
public class AlphaVantageDelegate implements MainPresenter,
    ...
    public void onCachedDataError() {
        view.showLoading("Fetching data for " + ticker.toUpperCase() + " : " + timeFrame.toString() + " from Alpha Vantage");
    ...
    public void onPivotCompleted(List<LiquidityLevel> pivots) {
        ...
        if(fundamentalData) {
            ...
            view.onComplete(ticker, timeFrame.toString());
        }
    }
