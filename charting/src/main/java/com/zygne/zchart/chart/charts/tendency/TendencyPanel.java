package com.zygne.zchart.chart.charts.tendency;

import com.zygne.zchart.chart.charts.volumeatprice.VolumePriceChart;
...
public class TendencyPanel extends JPanel {

    private VolumePriceChart volumePriceChart;
    private JPanel parent;

    public TendencyPanel(JPanel parent){
        this.parent = parent;
