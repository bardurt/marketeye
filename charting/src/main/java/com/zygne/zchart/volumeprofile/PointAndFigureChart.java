...
import com.zygne.zchart.volumeprofile.model.data.PnfItem;
import com.zygne.zchart.volumeprofile.model.data.PointAndFigure;
import com.zygne.zchart.volumeprofile.model.data.PointAndFigureBox;
import com.zygne.zchart.volumeprofile.model.data.Quote;
import com.zygne.zchart.volumeprofile.util.GroupingGenerator;
import com.zygne.zchart.volumeprofile.util.PnFCalc;
import com.zygne.zchart.volumeprofile.util.PointAndFigureUtil;
...
public class PointAndFigureChart extends MouseInputAdapter implements Chart {
    ...
    public void setQuotes(List<Quote> quotes) {
        ...
        double minValue = (this.quotes.get(quotes.size() - 1).getHigh() * 0.95);

        Collections.sort(this.quotes, new Quote.TimeComparator());

        double priceChange = this.quotes.get(quotes.size() - 1).getClose() * 0.01;
